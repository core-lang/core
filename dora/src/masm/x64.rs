    ...
    pub fn int_reverse_bits(&mut self, mode: MachineMode, dest: Reg, src: Reg) {
        match mode {
            MachineMode::Int32 => {
                ...
                self.asm.shrl_ri((*scratch1).into(), Immediate(1));
                ...
                self.asm.shll_ri((*scratch2).into(), Immediate(1));
                ...
                self.asm.shll_ri((*scratch4).into(), Immediate(2));
                ...
                self.asm.shll_ri(dest.into(), Immediate(4));
            ...
            MachineMode::Int64 => {
                ...
                self.asm.shlq_ri((*scratch4).into(), Immediate(2));
                ...
                self.asm.shlq_ri(dest.into(), Immediate(4));
