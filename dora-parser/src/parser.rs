...
mod tests {
    ...
    fn parse_value_empty() {
        ...
        assert_eq!(0, value.fields.len());
        assert_eq!("Foo", *interner.str(value.name));
    }
    ...
    fn parse_value_one_field() {
        ...
        let value = prog.value0();
        assert_eq!(1, value.fields.len());
        assert_eq!("Bar", *interner.str(value.name));

        let f1 = &value.fields[0];
    ...
    fn parse_value_multiple_fields() {
        ...
        assert_eq!("FooBar", *interner.str(value.name));

        let f1 = &value.fields[0];
        assert_eq!("fa", *interner.str(f1.name));

        let f2 = &value.fields[1];
