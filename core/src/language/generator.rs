...
impl<'a> AstBytecodeGen<'a> {
    ...
    fn visit_expr_dot_value(
        ...
        let value_obj = self.visit_expr(&expr.lhs, DataDest::Alloc);
        ...
        let const_idx = self
            .builder
            .add_const_value_field(value_id, type_params, field_idx);
        self.builder
            .emit_load_value_field(dest, value_obj, const_idx);
...
pub fn bty_from_ty(ty: SourceType) -> BytecodeType {
    match ty {
        ...
        SourceType::Value(value_id, type_params) => BytecodeType::Value(value_id, type_params),
        SourceType::Union(union_id, type_params) => BytecodeType::Union(union_id, type_params),
